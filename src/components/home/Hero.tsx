    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 flex flex-col items-center px-6 w-full">
        ...
        <motion.h1
          ...
          className="relative font-yu text-[64px] md:text-[110px] lg:text-[140px] leading-[1.05] text-kinpaku tracking-[0.18em] pl-[0.18em] mt-2"
        >
          神無月
        </motion.h1>
        ...
        >
          Free Company & Cross-world Linkshell
        </motion.p>

      </div>

      {/* 向下滚动指示 — section 直接子元素，避免被父级 flex 容器影响定位 */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
